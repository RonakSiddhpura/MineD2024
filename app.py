# This project has taken more than 100 hours of sincere efforts.
...
def main():
    ...
    base_path = "E:\Programming & Coding\Projects\Competitions and Hack a Thons\MINeD Hackathon\Submission\Chat PDF Huggingface\Experimental Inputs"
    ...
    if pdf is not None:
        ...
        if user_question:
            ...
            # llm = HuggingFaceHub(repo_id="google/gemma-7b", model_kwargs={"temperature":0.1, "max_length":64}) # best of google, but generative
            # llm = HuggingFaceHub(repo_id="google/gemma-2b", model_kwargs={"temperature":0.1, "max_length":64}) #
            # llm = HuggingFaceHub(repo_id="google/mt5-large", model_kwargs={"temperature":5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="google/mt5-base", model_kwargs={"temperature":5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="google/mt5-small", model_kwargs={"temperature":5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="google/flan-t5-small", model_kwargs={"temperature":5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="google/flan-t5-xl", model_kwargs={"temperature":0.5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="google/flan-t5-xxl", model_kwargs={"temperature":0.5, "max_length":64}) # 
            # llm = HuggingFaceHub(repo_id="distilbert/distilgpt2", model_kwargs={"temperature":0.6, "max_length":1024}) #
